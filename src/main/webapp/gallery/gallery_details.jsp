        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="ms-3 text-light">
                            ...
                            <fmt:formatDate value="${gallery.createdDate}" pattern="MMMM d, yyyy"/>
                        </span>
                    </div>
                </div>
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <c:if test="${isOwner}">
                        <div class="btn-group">
                            <a href="${pageContext.request.contextPath}/gallery/upload_photos.jsp?galleryId=${gallery.galleryId}" class="btn btn-light">
                                            ...
                                            <a href="${pageContext.request.contextPath}/${photo.filePath}" data-lightbox="gallery" data-title="${not empty photo.title ? photo.title : photo.originalFileName}">
                                                                                        ...
                                                                                        <div class="photo-overlay">
                                                                                            ...
                                                                                            <div class="photo-meta mt-2">
                                                                                                <small>
                                                                                                    <fmt:formatDate value="${photo.uploadDate}" pattern="MMM d, yyyy"/>
                                                                                                </small>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <c:otherwise>
                                                                    <div class="no-photos">
                                                                        ...
                                                                        <c:if test="${isOwner}">
                                                                            <a href="${pageContext.request.contextPath}/gallery/upload_photos.jsp?galleryId=${gallery.galleryId}" class="btn btn-primary mt-3">
                                                            ...
                                                            <div class="gallery-details">
                                                                ...
                                                                <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
                                                                        ...
                                                                        <span><fmt:formatDate value="${gallery.createdDate}" pattern="MMMM d, yyyy"/></span>
                                                                    </li>
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
                                                                        <span>Last Updated</span>
                                                                        <span><fmt:formatDate value="${gallery.lastUpdatedDate}" pattern="MMMM d, yyyy"/></span>
                                                                    </li>
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
                                                                        <span>Category</span>
